 ...
 */
@Mixin(targets = "net.minecraft.gametest.framework.GameTestBatchRunner$1")
public class GameTestBatchRunner1Mixin {

    @WrapOperation(method = "method_54842", at = @At(value = "INVOKE", target = "Lnet/minecraft/server/level/ServerLevel;setChunkForced(IIZ)Z"))
